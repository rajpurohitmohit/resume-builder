      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Smart, role-based bullet points and summaries generated
          ...
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className={`p-6 group-hover:${themeColors.bgLight} border border-transparent group-hover:${themeColors.border} flex gap-4 rounded-xl transition-colors`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className={`size-6 ${themeColors.stroke}`}
              >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Clean formatting that passes ATS filters, with your data kept
                  private and secure.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                <h3 className="text-base font-semibold text-slate-700">
                  Easy Customization & Export
                </h3>
                <p className="text-sm text-slate-600 max-w-xs">
                  Adjust sections and styling, then download in PDF or DOCX in
                  one click.
                </p>
              </div>
            </div>
