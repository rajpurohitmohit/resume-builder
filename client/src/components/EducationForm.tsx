            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <input
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none"
                ...
                <input
                  type="text"
                  placeholder="Degree (e.g., Bachelor's, Mastter's)"
                  className="px-3 py-2 text-sm border border-gray-300 focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none"
                ...
                <input
                  type="month"
                  className="px-3 py-2 text-sm border border-gray-300 focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none disabled:bg-gray-100"
